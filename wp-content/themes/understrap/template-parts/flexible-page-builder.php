<?php if ( have_rows( 'flexible_page_builder' ) ): ?>
	...
	$i++; ?>
		...
		<?php elseif ( get_row_layout() == 'trip_filter_block' ) : ?>
			<div id="trip-filter-block-<?php echo get_row_index();?>">
				<?php if ( get_sub_field( 'trip_filter_section' ) == 1 ) { 
					include( get_template_directory() . '/components/trip-search-block.php'); 
				} else { 
		...
		<?php elseif ( get_row_layout() == 'row' ) : ?>
			...
			<div class="full-row <?php the_sub_field( 'background_color' ); ?>">
				<div class="container">
					<div class="row ue-<?php echo $uneven ?>">
